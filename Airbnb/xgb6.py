...
df_train = pd.read_csv('C:/Users/1/Desktop/kaggle/airbnb/data/train_users_sessions6.csv')
df_test = pd.read_csv('C:/Users/1/Desktop/kaggle/airbnb/data/test_users_sessions6.csv')
...
for i in range(num_cv):
    ...
    X_train, X_test, y_train, y_test = cross_validation.train_test_split(X, y, test_size=0.02, random_state=np.random.randint(10,1000))
    ...
    sub.to_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/1_2.csv',index=False)
