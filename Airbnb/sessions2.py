...
sessions['secs_elapsed_log'] = np.log(sessions['secs_elapsed']+1)
...
action = pd.pivot_table(sessions, index = ['user_id'],columns = ['action'],values = 'secs_elapsed_log',aggfunc='mean',fill_value=0).reset_index()
...
sessions = sessions.drop(['secs_elapsed_log'], axis=1)
...
df_train_sessions.to_csv('C:/Users/1/Desktop/kaggle/airbnb/data/train_users_sessions6.csv')
df_test_sessions.to_csv('C:/Users/1/Desktop/kaggle/airbnb/data/test_users_sessions6.csv')