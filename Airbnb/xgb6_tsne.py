...
df_all.to_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/df_all_2.csv',index=False)
...
for i in range(num_cv):
    print i
    df_all_new = pd.read_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/df_all_2.csv')
    ...
    ohe_feats = ['gender', 'signup_method', 'language', 'affiliate_channel', 'affiliate_provider',
                                     'first_affiliate_tracked', 'signup_app', 'first_device_type', 'first_browser', 'age_gender']
    ...
    df_vis['x'] = vis_x
    df_vis['y'] = vis_y
    sns.lmplot('x', 'y', hue="smoker", data=df_vis);
...
sub.to_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/1_7_lb.csv',index=False)
