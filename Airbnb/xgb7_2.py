...
#Age_grouping
av = df_all.age.values
df_all['age_group']  = np.where(np.logical_and(av >= 14, av <= 18), 1, 0)
bv = df_all.age_group.values
df_all['age_group']  = np.where(np.logical_and(av > 18, av <= 24), 2, bv)
bv = df_all.age_group.values
...
df_all.to_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/df_all_3_2.csv',index=False)
...
for i in range(num_cv):
    print i
    df_all_new = pd.read_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/df_all_3_2.csv')
...
for i in range(num_cv):
    print i
    df_all_new = pd.read_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/df_all_3.csv')
    ...
    print('error', error)
    print("Predicting...")
    y_pred_test2 = y_pred_test2 + gbm.predict(dtest)

y_pred_test2 = y_pred_test2/num_cv

y_pred_test = (y_pred_test+0*y_pred_test2)
...
sub.to_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/3_2_100_00_lb.csv',index=False)


y_pred_test = (0*y_pred_test+y_pred_test2)
#Taking the 5 classes with highest probabilities
ids = []  #list of ids
cts = []  #list of countries
for j in range(len(id_test)):
...
#Generate submission
sub = pd.DataFrame(np.column_stack((ids, cts)), columns=['id', 'country'])
sub.to_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/3_2_00_100_lb.csv',index=False)

y_pred_test = (y_pred_test+y_pred_test2)/2
#Taking the 5 classes with highest probabilities
ids = []  #list of ids
cts = []  #list of countries
for j in range(len(id_test)):
...
#Generate submission
sub = pd.DataFrame(np.column_stack((ids, cts)), columns=['id', 'country'])
sub.to_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/3_2_50_50_lb.csv',index=False)


y_pred_test = (0.8*y_pred_test+0.2*y_pred_test2)
#Taking the 5 classes with highest probabilities
ids = []  #list of ids
cts = []  #list of countries
for j in range(len(id_test)):
...
#Generate submission
sub = pd.DataFrame(np.column_stack((ids, cts)), columns=['id', 'country'])
sub.to_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/3_2_80_20_lb.csv',index=False)


y_pred_test = (0.2*y_pred_test+0.8*y_pred_test2)
#Taking the 5 classes with highest probabilities
ids = []  #list of ids
cts = []  #list of countries
for j in range(len(id_test)):
...
#Generate submission
sub = pd.DataFrame(np.column_stack((ids, cts)), columns=['id', 'country'])
sub.to_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/3_2_20_80_lb.csv',index=False)
