...
df_all.to_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/df_all_3.csv',index=False)
...
sub.to_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/3_50_50_lb.csv',index=False)


y_pred_test = (0.8*y_pred_test+0.2*y_pred_test2)/2
#Taking the 5 classes with highest probabilities
ids = []  #list of ids
cts = []  #list of countries
for j in range(len(id_test)):
...
#Generate submission
sub = pd.DataFrame(np.column_stack((ids, cts)), columns=['id', 'country'])
sub.to_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/3_80_20_lb.csv',index=False)


y_pred_test = (0.2*y_pred_test+0.8*y_pred_test2)/2
#Taking the 5 classes with highest probabilities
ids = []  #list of ids
cts = []  #list of countries
for j in range(len(id_test)):
...
#Generate submission
sub = pd.DataFrame(np.column_stack((ids, cts)), columns=['id', 'country'])
sub.to_csv('C:/Users/1/Desktop/kaggle/airbnb/temp/3_20_80_lb.csv',index=False)
